...
struct Walkthrough: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 10) {
                ...
                Button {
                    ...
                    Text("Get Started")
                        ...
                        .padding(.bottom, screenSize.height / 10)
        ...
        .background(
            WaveForm(color: Color("screen\(Int(CGFloat(getIndex()).rounded() + 1))"), amplify: 75, isReversed: true)

        )
        .background(
            WaveForm(color: Color("screen\(Int(CGFloat(getIndex()).rounded() + 1))").opacity(0.2), amplify: 40, isReversed: false)
